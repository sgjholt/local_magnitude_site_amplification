...
for f in ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10']:
   ...
   subprocess.check_call(
       'gs -sDEVICE=pdfwrite -dNOPAUSE -dBATCH -dSAFER -sOutputFile={0}hz_MagDistDelta_1.pdf plots/*.eps'.format(f),
       shell=True)
   subprocess.check_call('mv {0}hz_MagDistDelta_1.pdf plots/ampl_plots/.'.format(f), shell=True)
